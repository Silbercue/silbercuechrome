  ...
  const server = new McpServer(
    ...
    },
    {
      instructions: [
        ...
        "",
        "Workflow: virtual_desk → switch_tab (or navigate) → view_page → click/type/fill_form using refs.",
        "",
        "Token-efficiency rules:",
        "- view_page (accessibility tree with refs like 'e5') is 10-30x cheaper than capture_image.",
        "- capture_image CANNOT drive click/type — only view_page returns usable element refs.",
